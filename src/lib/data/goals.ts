...
export const MARKETING_GOALS: MarketingGoal[] = [
  ...
  // ========================================
  {
    ...
    recommendedTools: ["chatgpt", "claude", "buffer-ai", "canva-ai", "later", "taplio", "predis-ai", "hootsuite"],
    workflow: {
      description:
  ...
  {
    id: "create-presentations-and-decks",
    title: "Create Presentations and Pitch Decks",
    description:
      "Build professional presentations, pitch decks, and slide decks in minutes using AI — no designer needed. Turn prompts, documents, or briefs into polished slides ready to present or share.",
    category: "content-marketing",
    tags: [
      "presentations",
      "slides",
    ...
    difficulty: "beginner",
    estimatedTimeframe: "Under 10 minutes",
    recommendedTools: [
      "textdeck",
      "xpptx",
      "canva-ai",
    ...
    workflow: {
      description: "Create a professional presentation in under 10 minutes with AI",
      steps: [
        "Define your goal: pitch deck, marketing presentation, client proposal, or training deck",
        "Choose your tool: TextDeck or Gamma for prompt-to-slides, Xpptx for converting existing docs",
        "Write a detailed prompt with your topic, audience, number of slides, and key points",
        "Generate the deck and download as PPTX",
        "Open in PowerPoint or Google Slides to customize colors, fonts, and images",
        "Add brand elements with Canva AI if needed before presenting",
      ],
    },
    examplePrompts: [
      "Create a 10-slide pitch deck for a local marketing agency. Cover: services, target clients, case studies, pricing, and why choose us.",
      "Build a 8-slide presentation on how AI tools save small businesses time and money. Professional tone, include stats and examples.",
      "Generate a 6-slide proposal for a social media management package. Include scope, deliverables, timeline, and pricing.",
    ],
  },

  {
    id: "boost-productivity-with-ai",
    title: "Boost Productivity with AI Tools",
    description:
      "Use AI to eliminate time-wasting tasks, automate note-taking, manage workflows, and get more done in less time. Perfect for small teams and solo operators who wear many hats.",
    category: "automation",
    tags: [
      "productivity",
      "time saving",
    ...
    workflow: {
      ...
      steps: [
        "Identify your biggest time wasters (meeting notes, content drafting, data entry, scheduling)",
        "Set up Supernormal or Otter.ai for automatic meeting transcription and notes",
        "Build a prompt library in TypingMind or Notion AI for recurring tasks",
        "Connect repetitive workflows with Zapier or Make (email to task, form to CRM)",
        "Use Claude or ChatGPT for first drafts of emails, reports, and proposals",
        "Review weekly time saved and identify the next workflow to automate",
      ],
    },
    examplePrompts: [
      "What are the 5 most repetitive tasks a small business owner can automate with AI today?",
      "Write a weekly status update email based on these bullet points: [paste notes]",
      "Summarize these meeting notes into action items with owners and due dates: [paste transcript]",
    ],
  },

  {
    id: "learn-ai-for-marketing",
    title: "Learn AI Tools for Marketing",
    description:
      "Get up to speed on AI marketing tools fast — even if you're non-technical. Build confidence using AI for content, video, social media, and automation without overwhelm.",
    category: "education",
    tags: [
      "ai training",
      "learn ai",
    ...
    difficulty: "beginner",
    estimatedTimeframe: "1-2 weeks to get comfortable",
    recommendedTools: [
      "chatgpt",
      "claude",
      "notebooklm",
    ...
    workflow: {
      description: "Go from AI beginner to confident AI marketer in 2 weeks",
      steps: [
        "Start with ChatGPT or Claude — ask it to explain anything you don't understand about AI marketing",
        "Pick ONE use case to start: writing, images, video, or social media",
        "Use NotebookLM to research and learn about your chosen AI tools",
        "Practice daily for 15 minutes — use AI to help with a real work task",
        "Save your best prompts in TypingMind or Notion as a personal library",
        "Expand to a second use case once the first feels comfortable",
      ],
    },
    examplePrompts: [
      "I'm a small business owner with no technical background. Explain how I can use AI to create marketing content this week. Keep it simple and practical.",
      "What are the 5 most important AI marketing tools a beginner should learn first? Explain what each one does in plain English.",
      "Create a 2-week AI learning plan for a non-technical small business owner who wants to use AI for social media and blog content.",
    ],
  },
...
const TOPIC_KEYWORDS: Record<string, string[]> = {
  ...
  "reels": ["video", "editing"],
  "tiktok video": ["video", "editing"],
  "short video": ["video", "editing"],
  ...
  "pitch deck": ["presentations", "slides"],
  "slide deck": ["presentations", "slides"],
  "powerpoint": ["presentations", "slides", "powerpoint"],
  "pptx": ["presentations", "slides"],
  "deck": ["presentations", "slides"],
  "create slides": ["presentations", "slides"],
  "make presentation": ["presentations", "slides"],
  "geo": ["seo", "geo"],
  "aio": ["seo", "geo", "aio"],
  "ai overview": ["seo", "geo", "aio"],
  "ai overviews": ["seo", "geo", "aio"],
  "generative engine optimization": ["seo", "geo"],
  "answer engine optimization": ["seo", "geo", "aio"],
  "rank in ai": ["seo", "geo"],
  "appear in ai": ["seo", "geo"],
  "perplexity ranking": ["seo", "geo"],
  "chatgpt search": ["seo", "geo"],
  "geo optimization": ["seo", "geo"],
  "ai search": ["seo", "geo"],
  "content autopilot": ["seo", "geo"],
  ...
  "social graphics": ["images", "graphics"],
  "social media": ["social-media", "social media"],
  "social content": ["social-media", "social media"],
  "social": ["social-media", "social media"],
  "instagram": ["social-media", "social media"],
  "linkedin": ["social-media", "social media", "linkedin"],
  "twitter": ["social-media", "social media"],
  "facebook": ["social-media", "social media"],
  "tiktok": ["social-media", "social media", "video"],
  "scheduling": ["social-media", "social media"],
  "social scheduling": ["social-media", "social media"],
  "post scheduling": ["social-media", "social media"],
  "social media management": ["social-media", "social media"],
  "content calendar": ["social-media", "social media", "content"],
  ...
  "facebook ads": ["ads", "advertising"],
  "instagram ads": ["ads", "instagram"],
  "linkedin ads": ["ads", "linkedin"],
  "paid social": ["ads", "advertising"],
  "ad copy": ["ads", "copywriting"],
  "run ads": ["ads", "advertising"],
  "ad campaign": ["ads", "advertising"],
  "automation": ["automation", "workflows"],
  "productivity": ["productivity", "efficiency", "time saving"],
  "save time": ["productivity", "time saving"],
  "time saving": ["productivity", "time saving"],
  "note taking": ["productivity", "meeting notes", "note taking"],
  "meeting notes": ["productivity", "meeting notes", "transcription"],
  "ai assistant": ["productivity", "ai assistant"],
  "task management": ["productivity", "automation"],
  "get more done": ["productivity", "efficiency"],
  "efficiency": ["productivity", "efficiency"],
  "workflow": ["automation", "workflows"],
  "automate": ["automation", "workflows"],
  "n8n": ["automation", "workflows"],
  "bardeen": ["automation", "workflows"],
  "browser automation": ["automation", "workflows"],
  "web scraping": ["automation", "workflows", "research"],
  "blog to video": ["video", "repurposing", "automation"],
  "content to video": ["video", "repurposing", "automation"],
  "script to video": ["video", "repurposing", "automation"],
  "pictory": ["video", "repurposing", "automation"],
  ...
  "website chatbot": ["chatbot", "customer support"],
  "customer support": ["chatbot", "customer support"],
  "live chat": ["chatbot", "customer support"],
  "support automation": ["chatbot", "customer support"],
  "proposals": ["proposals", "documents"],
  "client proposals": ["proposals", "documents"],
  "branded documents": ["proposals", "documents"],
  "one pager": ["proposals", "documents", "presentations"],
  "fast images": ["images", "visual content"],
  "quick images": ["images", "visual content"],
  "ai training": ["ai training", "learn ai"],
  "learn ai": ["ai training", "learn ai"],
  "ai education": ["ai training", "ai education"],
  "ai literacy": ["ai training", "ai literacy"],
  "team training": ["ai training", "team training"],
  "ai for beginners": ["ai training", "beginners"],
  "get started with ai": ["ai training", "beginners"],
  "non-technical": ["ai training", "beginners"],
  "beginners": ["ai training", "beginners"],
};
