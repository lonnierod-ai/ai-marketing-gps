...
const TOPIC_KEYWORDS: Record<string, string[]> = {
  ...
  "pdf to powerpoint": ["presentations", "slides"],
  "pdf to slides": ["presentations", "slides"],
  "word to powerpoint": ["presentations", "slides"],
  "word to slides": ["presentations", "slides"],
  "mind map to slides": ["presentations", "slides"],
  "document to slides": ["presentations", "slides"],
  "document to presentation": ["presentations", "slides"],
  "geo": ["seo", "geo"],
  "aio": ["seo", "geo", "aio"],
  ...
  "auto publish": ["seo", "content", "automation"],
  "auto publishing": ["seo", "content", "automation"],
  "content automation": ["seo", "content", "automation"],
  "automated content": ["seo", "content", "automation"],
  "autopilot content": ["seo", "content", "automation"],
