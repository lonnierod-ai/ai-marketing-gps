...
export const AI_TOOLS: AITool[] = [
  ...
  // ========================================
  {
    ...
    category: "content-creation",
    description:
      "AI assistant built directly into Microsoft 365 — Word, PowerPoint, Excel, Outlook, Teams, and OneDrive. Permanent SMB SKUs launched July 1, 2026: Business Standard with Copilot ($23.50/user/month) and Business Premium with Copilot ($32/user/month). Includes MAI-Image-2.5 for text-to-image and image-to-image generation inside PowerPoint, plus Work IQ (context layer over emails, docs, meetings), Web IQ (AI-first search), and Microsoft IQ across Copilot Studio and GitHub Copilot.",
    bestFor: [
      "Teams already on Microsoft 365 wanting AI without adding new tools",
      "Campaign brief drafting inside Word",
      "Presentation creation with AI-generated visuals in PowerPoint",
      "Content repurposing across email and documents",
      "5-person SMB teams on a sub-$500/month AI budget",
    ],
    proTip:
      "Run a 30-day pilot on three workflows — campaign brief drafting, presentation creation, and content repurposing — before committing. The answer on whether it fits your stack will be obvious within a week. Lock in pricing before July 1st if your team is already on M365.",
    tags: [
      "microsoft copilot",
      "microsoft 365",
      "m365",
    ...
    relatedTools: ["chatgpt", "claude", "notion-ai", "canva-ai", "grammarly"],
    url: "https://www.microsoft.com/en-us/microsoft-365/business/compare-all-plans",
    lastUpdated: "June 2026",
  },
  {
    id: "openai-codex-creative",
    name: "OpenAI Codex Creative Production",
    vendor: "OpenAI",
    category: "content-creation",
    description:
      "Role-specific Codex plugin built for marketing and creative production teams. Takes a brief and turns it into reviewable assets — campaign boards, display ad variations, product lifestyle shots, and ecommerce-ready image sets. Integrates with Figma, Canva, Shutterstock, Picsart, and Fal. Annotation feature lets you point at one section of a document or slide and ask Codex to revise only that part. Codex Sites (review hubs and interactive project boards) are available on Business and Enterprise plans.",
    bestFor: [
      "Brief-to-asset workflow for marketing teams",
      "Campaign concept generation without a design queue",
      "Ad variation creation at scale",
      "Product lifestyle and ecommerce image sets",
      "Agency teams compressing moodboard-to-first-draft turnaround",
    ],
    proTip:
      "Test it on one upcoming campaign brief and measure whether it cuts time to your first reviewable concept. Frame it for clients as redesigning the brief-to-asset workflow — not 'we use Codex.' Speed to first option is the differentiator.",
    tags: [
      "openai codex",
      "codex",
      "creative production",
    ...
    relatedTools: ["chatgpt", "claude", "canva-ai", "midjourney", "dall-e-3"],
  ...
  },
  {
    ...
    category: "video-generation",
    description:
      "Instagram's dedicated video creation app with expanded AI video generation tools, allowing content teams to produce social-ready video content without Runway-level complexity. Creator API upgrades (June 2026) improve integration with scheduling tools like Buffer, Later, and Publer for teams managing social workflows.",
    bestFor: [
      "Creating short social video content directly inside Instagram's ecosystem",
      "Non-technical creators who want AI video without complex tools",
      "Teams using Buffer, Later, or Publer for social scheduling",
      "Reels and short-form video production",
    ],
    proTip:
      "The Creator API improvements mean your existing scheduling tool (Buffer, Later, Publer) gets smarter Instagram integration — check for updates in your scheduling platform before building a new workflow.",
    tags: [
      "instagram edits",
      "instagram",
      "reels",
    ...
    relatedTools: ["buffer-ai", "canva-ai", "opusclip", "descript", "runway-gen-4"],
    url: "https://about.instagram.com/features/edits",
    lastUpdated: "June 2026",
  },
  // ========================================
