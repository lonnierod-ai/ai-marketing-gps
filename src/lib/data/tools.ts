...
export const AI_TOOLS: AITool[] = [
  ...
  },
  {
    ...
    category: "video-generation",
    subcategory: "editing",
    description: "AI-powered video and podcast editing that works like a word processor. Edit audio and video by editing the transcript, remove filler words automatically, create AI voice clones, and generate captions. Now also supports inline tone direction for AI voices, parallel media generation, and direct control from Claude or ChatGPT via MCP.",
    bestFor: [
      "Podcast editing",
      "Video content creation",
      "Repurposing long-form content into clips",
      "Teams without traditional video editing expertise",
      "Directing AI voice emotion inline instead of re-recording takes (Tone Tags, ElevenLabs v3 speakers)",
      "Running multiple AI media generation jobs at once to speed up production",
      "Controlling Descript projects directly through Claude or ChatGPT using natural language (MCP connector)",
    ],
    proTip: "Use Tone Tags (whisper, laugh, pause, excited, etc.) on ElevenLabs v3 speakers to direct your AI voiceover's emotional delivery inline instead of recording multiple takes. And test the Claude/ChatGPT MCP connector on a low-stakes project first — it lets you edit, generate media, and trigger publishes through plain-language commands, which is a real step toward assistant-run production for a solo or two-person team.",
    tags: ["video", "podcast", "editing", "transcription", "voice-cloning", "captions", "tone-tags", "ai-voice-direction", "elevenlabs", "concurrent-generation", "mcp", "claude-integration", "chatgpt-integration"],
    relatedTools: ["opusclip", "riverside-fm", "castmagic", "elevenlabs"],
  ...
  },
  {
    ...
    vendor: "SoraLum",
    category: "video-generation",
    description: "All-in-one platform for creating and editing images and videos using AI. Supports text-to-video, image-to-video, and image-to-image generation in a single workflow.",
    bestFor: [
      "Creating social media visuals and product videos",
      "Animated content without a designer",
      "Content marketers producing regular visual assets",
    ],
  ...
  },
  {
    ...
    vendor: "Latiai",
    category: "video-generation",
    description: "All-in-one AI image and video generator that creates stunning visuals from text prompts or reference photos. Features advanced models including Veo and Nano Banana for high-quality image and video production.",
    bestFor: [
      "Creators and marketers generating visuals from text or photo references",
      "High-quality image and short-form video production",
      "Teams wanting one tool for both image and video output",
    ],
  ...
  },
  {
    ...
    category: "video-generation",
    subcategory: "editing",
    description: "AI video editing tool that streamlines the editing process for long-form content. Automates sorting footage, syncing audio, and cutting unnecessary clips. Integrates with Premiere Pro, Final Cut Pro, and DaVinci Resolve.",
    bestFor: [
      "Content creators editing long-form video",
      "Podcast and YouTube creators who film their episodes",
      "Teams using Premiere Pro, Final Cut Pro, or DaVinci Resolve",
    ],
  ...
  },
  {
    ...
    vendor: "Adobe",
    category: "visual-content",
    description: "Adobe's creative AI platform, now a multi-model production hub rather than a single image generator. Firefly orchestrates partner video and image models — including Runway, Sora, Kling, and Veo — inside Adobe Creative Cloud, alongside its own image generation, text effects, vector graphics, and Firefly Boards for mood boards and concept work.",
    bestFor: [
      "Running model bake-offs — testing the same campaign brief against multiple AI video models in one workflow before picking the best output",
      "Teams using Adobe Creative Cloud who want partner AI models without separate logins and subscriptions",
      "Creating client mood boards and concept boards with Firefly Boards",
      "Ensuring commercially safe AI content with Adobe's own licensed-content models",
    ],
    proTip: "Map your team's Adobe plan and generative credit allowance before building Firefly into a weekly workflow — partner models burn credits at different rates, and a multi-model session can use up a budget fast. Also flag to clients that prompts and reference files sent to partner models (Runway, Sora, etc.) leave Adobe's own systems, even though Adobe says content isn't used to train those partner models.",
    tags: ["image", "video", "ai-generation", "adobe", "commercial-safe", "professional", "multi-model", "orchestration", "runway", "sora", "kling", "veo", "mood-board", "vector-graphics"],
    relatedTools: ["midjourney", "canva-ai", "imagen-4", "runway-gen-4", "sora-2"],
  ...
  },
  {
    ...
    vendor: "Drawjo",
    category: "visual-content",
    description: "AI-powered design tool built specifically for solo founders and startups. Enables users to create professional designs in minutes using premium AI models — no design experience required.",
    bestFor: [
      "Solo founders and small business owners who need professional visuals fast",
      "Startups without a dedicated designer",
      "Quick social media graphics, brand assets, and marketing visuals",
    ],
  ...
  },
  {
    ...
    vendor: "PicX Studio",
    category: "visual-content",
    description: "AI creative platform for creators and filmmakers that generates images and videos from text prompts using models like Nano Banana 2 and Seedance 2.0. Professional headshots, consistent characters, AI influencers, and text-to-video — no subscription, pay only for what you create.",
    bestFor: [
      "E-commerce sellers creating product photos without hiring photographers",
      "Generating professional LinkedIn and business headshots without a photoshoot",
      "Social media managers building AI influencer content and consistent brand visuals",
    ],
    proTip: "Use the headshot generator to create consistent professional team photos for your About page or LinkedIn — no studio booking required. Pay-per-use credits mean you're not locked into a subscription.",
    tags: ["image", "video", "ai-generation", "headshots", "product-photography", "ai-influencer", "text-to-video", "ecommerce", "social-media", "visual-content", "pay-per-use", "no-subscription", "nano-banana", "seedance"],
    relatedTools: ["latiai", "soralum-ai", "drawjo", "midjourney"],
    url: "https://picxstudio.com?ref=aimarketinggps",
    lastUpdated: "June 2026",
  },
  {
    id: "pixelweaver",
    ...
    vendor: "PixelWeaver",
    category: "visual-content",
    description: "Free AI image-to-image tool that restyles photos, replaces objects, and generates creative variations in seconds. Built for e-commerce and marketing teams who need fast product photo variants and on-brand visual edits without starting from scratch.",
    bestFor: [
      "E-commerce sellers generating product color and style variants from one hero shot",
      "Marketers testing multiple ad visual directions quickly from a single base image",
      "Quick background cleanup and product touch-ups for storefront listings",
    ],
    proTip: "Upload one strong product photo and generate 8-10 visual directions for ad testing — what used to take a full afternoon of manual edits now takes minutes.",
    tags: ["image", "image-editing", "image-to-image", "ai-generation", "product-photos", "ecommerce", "restyle", "inpainting", "outpainting", "upscaling", "no-design-skills", "visual-content", "free", "background-removal"],
    relatedTools: ["canva-ai", "midjourney", "z-image", "nearerai"],
    url: "https://pixelweaver.io?ref=aimarketinggps",
    lastUpdated: "June 2026",
  },
  {
    id: "z-image",
    ...
    category: "visual-content",
    description: "Open-source AI image generation model using a Single-Stream Diffusion Transformer architecture for fast, high-quality image synthesis. Notable for accurate bilingual text rendering in English and Chinese, making it useful for multilingual marketing visuals.",
    bestFor: [
      "Creating marketing graphics with accurate text rendering directly in the image",
      "Multilingual campaigns needing English and Chinese text in the same visual",
      "Fast, free image generation and editing for budget-conscious creators",
    ],
    proTip: "Z-Image's strength is rendering readable text inside images — most AI image tools produce garbled text. Use it for posters, banners, and social graphics where the words need to actually be legible.",
    tags: ["image", "ai-generation", "image-editing", "text-in-image", "bilingual", "multilingual", "open-source", "free", "fast-generation", "visual-content", "social-media", "posters", "banners"],
    relatedTools: ["midjourney", "dall-e-3", "nano-banana-pro", "pixelweaver"],
    url: "https://zimage.net?ref=aimarketinggps",
    lastUpdated: "June 2026",
  },
  {
    id: "nearerai",
    ...
    vendor: "NearerAI",
    category: "visual-content",
    description: "AI-powered photo restoration tool that revives damaged, blurry, or faded images into clear digital photos. Automatically removes scratches and imperfections, restores faded colors, and sharpens details with no technical skills required.",
    bestFor: [
      "Restoring old brand or founder photos for an About page or company history feature",
      "Businesses with archival or legacy product photography that needs cleanup",
      "Quick, no-skill photo repair for marketing materials using old source images",
    ],
    proTip: "If your business has old founder photos, early product shots, or scanned archival images you want to reuse in marketing, run them through NearerAI first — it can rescue images that would otherwise be unusable.",
    tags: ["image", "image-editing", "photo-restoration", "image-enhancement", "color-restoration", "old-photos", "no-design-skills", "visual-content", "archival", "free-tool"],
    relatedTools: ["pixelweaver", "z-image", "canva-ai"],
    url: "https://nearerai.com?ref=aimarketinggps",
    lastUpdated: "June 2026",
  },
  {
    id: "pixexact",
    ...
    vendor: "PixExact",
    category: "visual-content",
    description: "AI image generator that creates images in exact pixel dimensions (up to 4096×4096), eliminating the need for cropping or resizing after generation.",
    bestFor: [
      "Generate platform-ready ad creatives in exact required dimensions",
      "Social media graphics sized perfectly for each platform",
      "E-commerce product images in exact required dimensions from a single prompt",
    ],
    proTip: "No more post-generation cropping or resizing — generate Instagram posts at 1080×1080, Pinterest pins at 1000×1500, or Facebook ads at exact spec. One prompt, exact dimensions.",
    tags: ["image", "ai-generation", "exact-dimensions", "pixel-perfect", "ad-creatives", "social-media", "ecommerce", "product-photos", "no-resizing", "platform-ready", "instagram", "facebook-ads", "pinterest", "visual-content", "marketing-graphics"],
    relatedTools: ["midjourney", "dall-e-3", "canva-ai", "latiai", "drawjo"],
    url: "https://www.pixexact.com",
    lastUpdated: "June 2026",
  },
  {
    id: "pixpretty",
    ...
    vendor: "Tenorshare",
    category: "visual-content",
    description: "AI-powered online photo editing suite by Tenorshare offering background removal, portrait retouching, object removal, image extension, and batch processing.",
    bestFor: [
      "E-commerce sellers bulk-editing product photos",
      "Remove backgrounds, resize, and retouch without Photoshop or a designer",
      "Batch processing for high-volume photo editing",
    ],
    proTip: "Batch-edit 100+ product photos at once — remove backgrounds, retouch, and resize — without needing Photoshop skills or a designer. Perfect for e-commerce storefronts.",
    tags: ["image", "image-editing", "photo-editing", "background-removal", "portrait-retouching", "object-removal", "batch-processing", "ecommerce", "product-photos", "no-design-skills", "visual-content", "online-editor", "photo-enhancement", "bulk-editing", "tenorshare"],
    relatedTools: ["pixelweaver", "canva-ai", "nearerai", "z-image"],
  ...
  },
  {
    ...
    vendor: "ComicsAI",
    category: "content-creation",
    description: "Browser-based AI comic generator that turns text prompts into manga, webtoon, and comic panel sequences with consistent character design.",
    bestFor: [
      "Content creators producing branded comic-style content for social media storytelling",
      "Marketers creating product explainers in comic format",
      "Creating visual stories without any drawing skills",
    ],
    proTip: "Turn your product explainer or brand story into a comic — no drawing skills needed. Comics are highly shareable on social media and can simplify complex concepts.",
    tags: ["content-creation", "comics", "manga", "webtoon", "storytelling", "visual-content", "social-media", "no-drawing-skills", "product-explainer", "branding", "character-design", "ai-generation", "browser-based", "sequential-art", "illustrated-content"],
    relatedTools: ["midjourney", "dall-e-3", "canva-ai", "drawjo"],
    url: "https://www.comicsai.org",
    lastUpdated: "June 2026",
  },
  {
    id: "commentions",
    ...
    description: "Automated tool that posts brand-mention comments on high-engagement posts across X (Twitter), LinkedIn, and YouTube to generate inbound leads.",
    bestFor: [
      "Small businesses building brand visibility without paid ads",
      "Driving inbound leads by engaging in relevant social conversations automatically",
      "Consistent social media presence through automated engagement",
    ],
    proTip: "Set your brand keywords and target audience, then let Commentions automatically engage in relevant conversations across Twitter, LinkedIn, and YouTube — building visibility and generating leads while you sleep.",
    tags: ["social-media", "automation", "lead-generation", "engagement", "twitter", "linkedin", "youtube", "brand-visibility", "inbound-marketing", "no-paid-ads", "social-automation", "comment-automation", "organic-growth", "productivity", "marketing-automation"],
    relatedTools: ["buffer-ai", "hootsuite", "zapier", "notion-ai"],
    url: "https://www.commentions.com",
    lastUpdated: "June 2026",
  },
  ...
  {
    id: "meta-edits",
    name: "Edits (by Meta/Instagram)",
    vendor: "Meta",
    category: "social-productivity",
    description: "Meta's free mobile video creation app for Instagram and Facebook creators. Getting a new AI assistant that reads your actual Instagram performance data — views, retention, and what's working for your specific account — rather than giving generic content advice. Also includes multi-version A/B testing, audience insights, topic search, beat markers, and 4K watermark-free export.",
    bestFor: [
      "Instagram-focused creators and small businesses wanting a free, native video editor with built-in analytics",
      "Testing multiple versions of a Reel before publishing (A/B testing) to see what resonates",
      "Getting content ideas grounded in your own account's actual performance data, once the AI assistant rolls out broadly",
    ],
    proTip: "Download Edits now and get comfortable with the features already live — multi-version testing, audience insights, and Inspiration topic search — before the AI assistant rolls out broadly. If Instagram is your primary channel, this could replace a paid analytics or content ideation subscription. Mobile-only (iOS and Android), no desktop version.",
    tags: ["video", "social-media", "instagram", "editing", "analytics", "ai-generation", "free", "mobile-only", "reels", "content-ideation", "a-b-testing"],
    relatedTools: ["buffer-ai", "hootsuite", "opusclip", "descript"],
    url: "https://creators.instagram.com/edits/?ref=aimarketinggps",
    lastUpdated: "June 2026",
  },
  {
    id: "notion-ai",
  ...
  },
  {
    ...
    vendor: "Pendless",
    category: "marketing-automation",
    description: "AI-driven browser automation tool that lets users automate web tasks using natural language prompts. Designed to enhance productivity by simplifying repetitive online actions — no coding required.",
    bestFor: [
      "Automating repetitive browser-based tasks",
      "Non-technical users who want web automation without code",
      "Marketers and founders looking to save time on manual web workflows",
    ],
