...
export const AI_TOOLS: AITool[] = [
  ...
  // ========================================
  {
    ...
    category: "video-generation",
    description:
      "All-in-one platform for creating and editing images, prompts, and videos — including image-to-image, image-to-video, and text-to-video generation. Built for non-designers who need polished social media visuals and short video content without a design background.",
    bestFor: [
      "Social media visuals and short video clips",
      "Image-to-video animation for products",
      "Text-to-video for content marketers",
      "Non-designers running lean marketing teams",
      "Quick visual content without design skills",
    ],
    proTip:
      "Start with image-to-video to animate a still product photo — it's the fastest way to create thumb-stopping social content without filming anything.",
    tags: [
      "soralum",
      "soralum ai",
      "video",
